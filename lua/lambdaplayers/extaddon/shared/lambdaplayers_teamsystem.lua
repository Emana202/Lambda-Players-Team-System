...
local huntDown = CreateLambdaConvar( "lambdaplayers_teams_huntdownotherteams", 0, true, false, false, "If Lambda Teams should hunt down the members of other teams. Attack Other Teams should be enabled to work", 0, 1, { name = "Hunt Down Other Teams", type = "Bool", category = "Team System" } )
